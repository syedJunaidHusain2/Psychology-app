...
function TherapistAndTreatment() {
  return (
    <section className=" w-full therapist-and-treatments-sec flex flex-col items-center justify-center py-20 media-max-400:py-14">
      <div
        style={{ maxWidth: 1400 }}
      ...
      >
        ...
        >
          <div className="heading-div-of-therapist-and-treatments-sec flex items-center justify-center flex-col max-md:gap-4">
            ...
            <h3 className="h3-of-heading-div-of-therapist-and-treatments-sec flex items-baseline justify-center gap-4 media-max-362:gap-0 media-max-362:items-center media-max-362:flex-col">
          ...
          <div className="services-details-div-of-therapist-and-treatments-sec w-full flex items-start justify-center flex-wrap gap-x-5 gap-y-10 mt-10 media-max-594:gap-0 media-max-594:items-start media-max-594:justify-between media-max-594:gap-y-8">
            <ServicesCard />
          </div>
        </div>
      </div>
