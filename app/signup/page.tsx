...
import { FaUser, FaEnvelope, FaKey, FaEyeSlash, FaEye } from "react-icons/fa6";
...
function SignUp() {
  ...
  return (
    <main className=" w-full flex items-center justify-center">
      <div className="sign-up-container max-w-[1400px] w-full flex items-center justify-center">
        <div className="sign-up w-[84%] flex items-center flex-col justify-between h-screen">
          <div className="top-div-of-sign-up w-full flex items-center relative justify-center py-4">
            <span className=" absolute -bottom-[2px] h-[2px] w-screen bg-gray-200 border-bottom-of-top-div-of-sign-in"></span>
            <div className="left-div-of-top-div-of-sign-up flex items-center justify-start gap-8 w-1/2 media-max-500:gap-2">
              <span>O</span>
            ...
            <div className="right-div-of-top-div-of-sign-up flex items-center justify-end gap-4 w-1/2 media-max-500:gap-0 media-max-500:justify-between media-max-400:justify-end media-max-400:gap-1 media-max-362:flex-col media-max-362:justify-center media-max-362:items-end">
          ...
          <div className="bottom-div-of-sign-up flex items-center justify-center flex-col w-2/5 px-14 py-7 media-max-942:w-1/2 max-md:w-3/4 media-max-500:min-w-full media-max-500:p-0 ">
