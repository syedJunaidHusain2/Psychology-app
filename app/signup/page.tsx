  ...
  return (
    <main className=" w-full flex items-center justify-center">
      <div className="sign-up-container max-w-[1400px] w-full flex items-center justify-center">
        <div className="sign-up w-[82%] flex items-center flex-col justify-between h-screen">
          ...
          <span className=" absolute -bottom-[2px] h-[2px] w-screen bg-gray-200 border-bottom-of-top-div-of-sign-in"></span>
            <div className="left-div-of-top-div-of-sign-up flex items-center justify-start gap-8 w-1/2">
              <span>O</span>
            ...
            <div className="right-div-of-top-div-of-sign-up flex items-center justify-end gap-4 w-1/2">
          ...
          <div className="bottom-div-of-sign-up flex items-center justify-center flex-col w-2/5 px-14 py-7">
