...
const TeamSec = () => {
  ...
  return (
    <div className="max-w-[1400px] mx-auto">
      <div className=" px-6 py-10 sm:px-12 sm:py-16 lg:px-10 lg:py-20">
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="text-center text-2xl sm:text-3xl lg:text-h2 font-semibold mt-4">
            Our{" "}
            <span className="text-bg_color_primary text-3xl sm:text-4xl lg:text-h1 font-light allison_regular">
              Team
            </span>
          </div>
        ...
        <div className="grid grid-cols-4 gap-10 mt-5 max-md:grid-cols-1 max-xl:grid-cols-2   ">
