  ...
  return (
    <div className='bg-bg_color_primary text-white '>
      <div className='flex flex-col md:flex-row justify-around items-center py-8 px-4 md:px-8 lg:px-16 text-lg md:text-xl'>
        ...
        <div className='bg-slate-700 text-btnSize text-center md:text-left px-6 py-1 rounded-full cursor-pointer hover:shadow-custom transition-shadow duration-300'>
          Make Appointment
        </div>
      </div>
